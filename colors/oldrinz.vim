...
let s:palette.cterm.selec   = {'dark': "119", 'light': "111"}
...
let s:palette.cterm.special = {'dark': "141", 'light': "135"}
...
exe "hi! NormalGrey"     .s:fg_dgrey        .s:bg_backg        .s:fmt_n
...
exe "hi! NormalUnderline".s:fg_foreg        .s:bg_backg        .s:fmt_u
exe "hi! NormalReverse"  .s:fg_foreg        .s:bg_backg        .s:fmt_r
...
exe "hi! CursorLine"     .s:fg_none         .s:bg_backg        .s:fmt_c
...
exe "hi! ColorColumn"    .s:fg_cyan         .s:bg_backg        .s:fmt_n
...
exe "hi! Hyperlink"      .s:fg_blue         .s:bg_backg        .s:fmt_u
...
exe "hi! VariableBold"   .s:fg_cyan         .s:bg_backg        .s:fmt_b
