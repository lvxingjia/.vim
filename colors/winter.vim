...
let s:palette.bblue    = {'dark': "9"  , 'light': "9"  }
let s:palette.bgreen   = {'dark': "10" , 'light': "10" }
let s:palette.bcyan    = {'dark': "11" , 'light': "11" }
let s:palette.bred     = {'dark': "12" , 'light': "12" }
let s:palette.magenta  = {'dark': "13" , 'light': "13" }
let s:palette.yellow   = {'dark': "14" , 'light': "6"  }
...
exe "hi! Boolean"           .s:fg_magenta    .s:bg_none       .s:fmt_n
...
" Group4
exe "hi! Statement"         .s:fg_brown      .s:bg_none       .s:fmt_n
exe "hi! Conditional"       .s:fg_brown      .s:bg_none       .s:fmt_i
exe "hi! Repeat"            .s:fg_brown      .s:bg_none       .s:fmt_i
exe "hi! Label"             .s:fg_magenta    .s:bg_none       .s:fmt_n
exe "hi! Operator"          .s:fg_brown      .s:bg_none       .s:fmt_n
exe "hi! Keyword"           .s:fg_brown      .s:bg_none       .s:fmt_n
exe "hi! Exception"         .s:fg_red        .s:bg_none       .s:fmt_n
exe "hi! Unique"            .s:fg_brown      .s:bg_none       .s:fmt_n
" Group5
exe "hi! PreProc"           .s:fg_magenta    .s:bg_none       .s:fmt_n
exe "hi! Include"           .s:fg_brown      .s:bg_none       .s:fmt_n
exe "hi! Define"            .s:fg_brown      .s:bg_none       .s:fmt_n
exe "hi! Macro"             .s:fg_magenta    .s:bg_none       .s:fmt_n
exe "hi! PreCondit"         .s:fg_brown      .s:bg_none       .s:fmt_n
...
exe "hi! Structure"         .s:fg_cyan       .s:bg_none       .s:fmt_n
...
exe "hi! Modifier"          .s:fg_brown      .s:bg_none       .s:fmt_n
" Group7
exe "hi! Special"           .s:fg_cyan       .s:bg_none       .s:fmt_n
exe "hi! SpecialKey"        .s:fg_cyan       .s:bg_none       .s:fmt_n
exe "hi! SpecialTag"        .s:fg_cyan       .s:bg_none       .s:fmt_n
exe "hi! SpecialType"       .s:fg_cyan       .s:bg_none       .s:fmt_i
exe "hi! SpecialChar"       .s:fg_cyan       .s:bg_none       .s:fmt_n
...
exe "hi! Delimiter"         .s:fg_cyan       .s:bg_none       .s:fmt_n
exe "hi! Debug"             .s:fg_white      .s:bg_cyan       .s:fmt_n
" OtherGroup
exe "hi! Underlined"        .s:fg_cyan       .s:bg_none       .s:fmt_u
