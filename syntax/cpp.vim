...
syn region  cppOperand      start="\%(\<decltype\)\@<=(" end=")" oneline
...
syn region  cppTmplparam    start="<" end=">" oneline
...
hi def link cppOperand      Special
...
hi def link cppTmplparam    Special
